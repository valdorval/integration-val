...
<main class="main">
     <h3 class="heading-tertiary u-padding-bottom-big">Choisissez EZ Tracking</h3>
     <section class="avantage container">
          <div class="avantage__content">
               <div class="flex avantage__content--box u-margin-top-big">
                    ...
                    <article class="avantage__content--item">
                         <h4 class="heading-quaternary heading-quaternary--bold u-margin-bottom-normal">Formulaire de contact inclus</h3>
               ...
               <div class="flex avantage__content--box">
                    <article class="avantage__content--item">
